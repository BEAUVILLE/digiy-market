...
const T={
fr:{label:'Boutique partenaire active',desc:'Onglerie, soins de beauté, massage modelant, lipocavitation et produits d’hygiène femme et homme. Contact direct avec Fama.',products:'Voir les produits',profile:'Ouvrir la fiche',commission:'0 % de commission',message:'Bonjour FG NAILS, je viens de DIGIY MARKET et je souhaite voir vos produits disponibles.'},
en:{label:'Active partner shop',desc:'Nail care, beauty treatments, body massage, lipocavitation and hygiene products for women and men. Direct contact with Fama.',products:'View products',profile:'Open profile',commission:'0% commission',message:'Hello FG NAILS, I found you on DIGIY MARKET and would like to see the available products.'},
es:{label:'Tienda asociada activa',desc:'Manicura, cuidados de belleza, masaje modelador, lipocavitación y productos de higiene para mujeres y hombres. Contacto directo con Fama.',products:'Ver productos',profile:'Abrir la ficha',commission:'0 % de comisión',message:'Hola FG NAILS, vengo de DIGIY MARKET y deseo ver los productos disponibles.'},
de:{label:'Aktiver Partnershop',desc:'Nagelpflege, Schönheitspflege, Modellagemassage, Lipokavitation und Hygieneprodukte für Frauen und Männer. Direkter Kontakt mit Fama.',products:'Produkte ansehen',profile:'Profil öffnen',commission:'0 % Provision',message:'Hallo FG NAILS, ich komme von DIGIY MARKET und möchte die verfügbaren Produkte sehen.'},
it:{label:'Negozio partner attivo',desc:'Unghie, trattamenti di bellezza, massaggio modellante, lipocavitazione e prodotti per l’igiene di donne e uomini. Contatto diretto con Fama.',products:'Vedi prodotti',profile:'Apri la scheda',commission:'0% commissioni',message:'Buongiorno FG NAILS, vi ho trovato su DIGIY MARKET e vorrei vedere i prodotti disponibili.'},
nl:{label:'Actieve partnerwinkel',desc:'Nagelverzorging, schoonheidsbehandelingen, modelmassage, lipocavitatie en hygiëneproducten voor vrouwen en mannen. Direct contact met Fama.',products:'Bekijk producten',profile:'Profiel openen',commission:'0% commissie',message:'Hallo FG NAILS, ik kom via DIGIY MARKET en wil graag de beschikbare producten zien.'},
ar:{label:'متجر شريك نشط',desc:'العناية بالأظافر وخدمات التجميل والتدليك والليبـوكافيتيشن ومنتجات النظافة للنساء والرجال. تواصل مباشر مع فاما.',products:'عرض المنتجات',profile:'فتح الصفحة',commission:'0٪ عمولة',message:'مرحبًا FG NAILS، وصلت إليكم عبر DIGIY MARKET وأرغب في رؤية المنتجات المتوفرة.'}
};
function lang(){
